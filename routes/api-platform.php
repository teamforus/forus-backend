...
$router->group(['middleware' => 'api.auth'], static function () use ($router) {
    ...
    $router->group(['prefix' => 'organizations/{organization}/product-reservations/{product_reservation}'], function () use ($router) {
        ...
        $router->get('provider-messages', "Api\Platform\Organizations\ProductReservationsController@providerMessages");
        $router->post('provider-messages', "Api\Platform\Organizations\ProductReservationsController@storeProviderMessage");
        $router->get('provider-messages/{message}/export', "Api\Platform\Organizations\ProductReservationsController@exportProviderMessage");
    });
    ...
    $router->get('organizations/{organization}/email-logs', 'Api\Platform\Organizations\EmailLogsController@index');
    $router->get('organizations/{organization}/email-logs/{emailLog}/export', 'Api\Platform\Organizations\EmailLogsController@export');
