...
trait TestsBackoffice
{
     ...
     * @param array $validFundKeys Array of valid fund keys that can be used in requests.
     ...
     * @return void
     */
    protected function setupBackofficeResponses(
        array $credentials,
        array $residentBsn = ['123456789', '987654321'],
        array $eligibleBsn = ['123456789'],
        array $validFundKeys = ['fund_001', 'fund_002', 'fund_003'],
        ...
        Http::fake(function (Request $request, array $options) use (
            ...
            if ($method === 'POST' && str_ends_with($url, '/funds')) {
                ...
                if (!in_array($fund, $validFundKeys, true)) {
