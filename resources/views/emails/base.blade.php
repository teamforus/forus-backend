<html>
    ...
    <center>
        <table id="wrapperTable" cellpadding="0" cellspacing="0" border="0" style="{{ mail_config('base.wrapper_table') }}" bgcolor="{{ mail_config('base.body_bg_color') }}">
            <tr>
                <td valign="top" align="center" style="border-collapse: collapse;">
                    <div id="wrapper" style="{{ mail_config('base.wrapper') }}">
                        <table cellpadding="0" cellspacing="0" border="0" style="{{ mail_config('base.container') }}" bgcolor="{{ mail_config('base.body_bg_color') }}">
                            <tr>
                                <td style="border-collapse: collapse; padding: 24px 24px 32px;">
                                    <h1 style="{{ mail_config('base.h1_style') }}"> @yield('title')</h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" style="border-collapse: collapse;">
                                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0; width: 166px!important; text-align: center; margin: 0px auto;">
                                        <tr>
                                            <td align="center" style="{{ mail_config('base.button_td') }}">
                                                <a href="@yield('link')" target="_blank" style="{{ mail_config('base.button') }}">@yield('button_text')</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
