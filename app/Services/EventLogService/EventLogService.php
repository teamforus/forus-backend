...
class EventLogService implements IEventLogService
{
    ...
    {
        $modelMeta = [
            'fund' => fn(): array => $this->fundMeta($model),
            'fund_config' => fn(): array => $this->fundConfigMeta($model),
            'fund_request' => fn(): array => $this->fundRequestMeta($model),
            'fund_request_record' => fn(): array => $this->fundRequestRecordMeta($model),
            'fund_request_clarification' => fn(): array => $this->fundRequestClarificationMeta($model),
            'fund_top_up_transaction' => fn(): array => $this->fundTopUpTransactionMeta($model),
            'sponsor' => fn(): array => $this->sponsorMeta($model),
            'provider' => fn(): array => $this->providerMeta($model),
            'product' => fn(): array => $this->productMeta($model),
            'voucher' => fn(): array => $this->voucherMeta($model),
            'organization' => fn(): array => $this->organizationMeta($model),
            'employee' => fn(): array => $this->employeeMeta($model),
            'product_reservation' => fn(): array => $this->productReservationMeta($model),
            'voucher_transaction' => fn(): array => $this->voucherTransactionMeta($model),
            'voucher_record' => fn(): array => $this->voucherRecordMeta($model),
            'physical_card' => fn(): array => $this->physicalCardMeta($model),
            'physical_card_request' => fn(): array => $this->physicalCardRequestMeta($model),
            'bank' => fn(): array => $this->bankMeta($model),
            'bank_connection' => fn(): array => $this->bankConnectionMeta($model),
            'bank_connection_account' => fn(): array => $this->bankConnectionAccountMeta($model),
            'voucher_transaction_bulk' => fn(): array => $this->voucherTransactionBulkMeta($model),
            'implementation' => fn(): array => $this->implementationMeta($model),
            'reimbursement' => fn(): array => $this->reimbursementMeta($model),
            'mollie_connection' => fn(): array => $this->mollieConnectionMeta($model),
            'reservation_extra_payment' => fn(): array => $this->reservationExtraPaymentMeta($model),
        ];
