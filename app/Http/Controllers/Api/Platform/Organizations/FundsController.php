...
class FundsController extends Controller
{
    ...
    public function financesOverview(
        ...
        return $request ? response()->json([
            ...
            'used_active_vouchers' => currency_format($totals['total_budget_used_active_vouchers']),
            ...
            'budget' => [
                ...
                'used_active_vouchers'              => currency_format($totalsBudget['total_budget_used_active_vouchers']),
