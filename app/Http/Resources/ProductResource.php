...
class ProductResource extends Resource
{
    ...
    public function toArray($request): array
    {
        ...
        return array_merge($product->only([
            ...
            'expire_at' => $product->expire_at ? $product->expire_at->subDay()->format('Y-m-d') : null,
            'expire_at_locale' => format_date_locale($product->expire_at->subDay() ?? null),
    ...
    private function getProductFunds(Product $product) {
        return FundQuery::whereProductsAreApprovedAndActiveFilter(
            ...
            return array_merge([
                ...
                'end_at' => $fund->end_date ? $fund->end_date->subDay()->format('Y-m-d') : null,
                'end_at_locale' => format_date_locale($fund->end_date->subDay() ?? null),
