...
class UpdateFundBackofficeRequest extends BaseFormRequest
{
     ...
     *
     * @psalm-return array{backoffice_enabled: 'nullable|boolean', backoffice_url: 'nullable|string|min:0|max:191|url|starts_with:https://', backoffice_key: 'nullable|string|min:0|max:191', backoffice_certificate: 'nullable|string|min:0|max:8000', backoffice_fallback: 'nullable|boolean', backoffice_ineligible_policy: string, backoffice_ineligible_redirect_url: array<string>}
     */
     ...
     * @return string[]
     *
     * @psalm-return list{'nullable', 'required_if:backoffice_ineligible_policy,redirect', 'string', 'min:0', 'max:2000', 'url', 'starts_with:https://'}
     */
