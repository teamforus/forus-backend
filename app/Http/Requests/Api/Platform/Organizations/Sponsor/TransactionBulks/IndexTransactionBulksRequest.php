...
class IndexTransactionBulksRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'amount_min'    => 'nullable|numeric|min:0|max:100000000',
            'amount_max'    => 'nullable|numeric|min:0|max:100000000',
            'quantity_min'  => 'nullable|numeric|min:0|max:100000000',
            'quantity_max'  => 'nullable|numeric|min:0|max:100000000',
