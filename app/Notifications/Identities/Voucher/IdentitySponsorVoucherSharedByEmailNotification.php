 ...
 */
class IdentitySponsorVoucherSharedByEmailNotification extends BaseIdentityVoucherNotification
{
    protected static ?string $key = 'notifications_identities.sponsor_voucher_shared_by_email';
    ...
    public function toMail(Identity $identity): void
    {
        ...
        $mailable = new SendVoucherBySponsorMail(
            $this->eventLog->data,
