...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('fund_configs', function (Blueprint $table) {
            ...
            $table->decimal('custom_amount_min')->default(false)->nullable()->after('allow_preset_amounts_validator');
            $table->decimal('custom_amount_max')->default(false)->nullable()->after('custom_amount_min');
        });
    }
